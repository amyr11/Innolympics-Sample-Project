...
void goalInputDialog({required BuildContext context, required GlobalKey<FormState> formKey, required String submitButtonLabel, String? dName, double? dSaved, double? dPrice, Category? dCategory, Frequency? dFrequency, DateTime? dTargetDate, required Function(String? name, double? saved, double? price, Category? category, Frequency? frequency, DateTime? targetDate) onSubmit}) {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                TextFormField(
                  initialValue: dTargetDate != null ? DateFormat('MMMM d, y').format(targetDate!) : null,
